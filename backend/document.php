                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">ເພີ່ມຂໍ້ມູນເອກະສານ</h5>
                        ...
                        <table id="table" data-search-selector="#inCus" data-pagination="true" data-custom-search="customSearch" data-search="true" data-click-to-select="true" data-resizable="true" data-id-field="id" data-page-list="[10, 25, 50, 100, all]" data-search-highlight="true">
                            <thead>
                                <tr class="table-primary">
                                    ...
                                    <th>ແກ້ໄຂ</th>
                                    <th data-field="id" data-sortable="true">ລະຫັດເອກະສານ</th>
                                    <th data-field="doc_title" data-sortable="true">ຫົວຂໍ້</th>
                                    <th data-field="doc_description" data-sortable="true">ເນີ້ອໃນ</th>
                                    <th data-field="doc_image" data-sortable="true">ຮູບ</th>
                                    <th class="hide"></th>
                                </tr>
                            </thead>
                            <?php
                            while ($row = mysqli_fetch_array($document_select)) {
                            ?>
                                <tr>
                                    <td></td>
                                    ...
                                    <td><?= $row["doc_id"] ?></td>
                                    <td><?= $row["doc_title"] ?></td>
                                    <td style="display: none"><?= $row["doc_description"] ?></td>
                                    <td>
                                        <a href="<?= $path ?>image/profile/<? echo $row["doc_image"] ?>" target="_blank">
                                            <img src="<?= $path ?>image/profile/<? echo $row["doc_image"] ?>" class="img-circle elevation-2" alt="User Image" style="width: 70px;height: 55px;">
                                        </a>
                                    </td>
                                    <td style="display: none"><?= $row["doc_image"] ?></td>
                                </tr>
                            <?php
                            }
